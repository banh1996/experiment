...
static int flash_process(int sockfd,
...
int main(int argc, char **argv)
{
    ...
    if (memcmp(argv[1], "continue", 8) == 0)
    {
        ...
        if (argc == 2)
        {
            ...
            {
                sDEBUG_LOG(appl_hex_file, "AdasSafetyMcuICE.hex");
                sDEBUG_LOG(appl_sign_file, "AdasSafetyMcuICE_hmac.sig");
            }
        }
#endif
