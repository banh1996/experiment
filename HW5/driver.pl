...
#
print colored("1. Running './dlc -z' to identify coding rules violations.\n", "white");
...
#
print colored("\n4. Running './dlc -e' to get operator count of each function.\n", "white");
...
print "\n";
printf("%s\n", "Correctness Results");
printf("%s\t%s\t%s\t%s\n", "Points/Total", "Errors", "Operators", "Puzzle");
...
print "\nScore = $tpoints/$trating [$total_c_points/$total_c_rating Corr] ($tops total operators)\n";
