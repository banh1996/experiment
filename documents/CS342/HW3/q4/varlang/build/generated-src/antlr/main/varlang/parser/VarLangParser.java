...
public class VarLangParser extends Parser {
	...
	public static final int
		T__0=1, T__1=2, T__2=3, T__3=4, T__4=5, T__5=6, Define=7, Let=8, Letu=9, 
		Dot=10, Number=11, Identifier=12, Letter=13, LetterOrDigit=14, AT=15, 
		ELLIPSIS=16, WS=17, Comment=18, Line_Comment=19;
	public static final int
		RULE_exp = 0, RULE_varexp = 1, RULE_letexp = 2, RULE_letuexp = 3, RULE_program = 4, 
		RULE_numexp = 5, RULE_addexp = 6, RULE_subexp = 7, RULE_multexp = 8, RULE_divexp = 9;
	public static final String[] ruleNames = {
		"exp", "varexp", "letexp", "letuexp", "program", "numexp", "addexp", "subexp", 
		"multexp", "divexp"
	};

	private static final String[] _LITERAL_NAMES = {
		null, "'('", "')'", "'-'", "'+'", "'*'", "'/'", "'define'", "'let'", "'letu'", 
		"'.'", null, null, null, null, "'@'", "'...'"
	};
	private static final String[] _SYMBOLIC_NAMES = {
		null, null, null, null, null, null, null, "Define", "Let", "Letu", "Dot", 
	...
	public static class ExpContext extends ParserRuleContext {
		...
		public LetuexpContext letuexp() {
			return getRuleContext(LetuexpContext.class,0);
		}
	...
	public final ExpContext exp() throws RecognitionException {
		...
		try {
			...
			case 8:
				...
				{
				setState(41);
				((ExpContext)_localctx).lu = letuexp();
	...
	public static class LetuexpContext extends ParserRuleContext {
		...
		public ExpContext e;
		public ExpContext body;
		public TerminalNode Letu() { return getToken(VarLangParser.Letu, 0); }
		public List<ExpContext> exp() {
			return getRuleContexts(ExpContext.class);
		}
		public ExpContext exp(int i) {
		...
		public LetuexpContext(ParserRuleContext parent, int invokingState) {
			super(parent, invokingState);
		}
		@Override public int getRuleIndex() { return RULE_letuexp; }
	}
	...
	public final LetuexpContext letuexp() throws RecognitionException {
		...
		try {
			...
			do {
				...
				match(T__0);
				setState(71);
				((LetuexpContext)_localctx).id = match(Identifier);
				setState(72);
				((LetuexpContext)_localctx).e = exp();
				setState(73);
				match(T__1);
				 _localctx.names.add((((LetuexpContext)_localctx).id!=null?((LetuexpContext)_localctx).id.getText():null)); _localctx.value_exps.add(((LetuexpContext)_localctx).e.ast); 
				}
				}
				setState(78); 
				_errHandler.sync(this);
			...
			match(T__1);
			setState(81);
			((LetuexpContext)_localctx).body = exp();
			setState(82);
			match(T__1);
			 ((LetuexpContext)_localctx).ast =  new LetuExp(_localctx.names, _localctx.value_exps, ((LetuexpContext)_localctx).body.ast); 
			}
		}
		catch (RecognitionException re) {
			_localctx.exception = re;
	...
	public static final String _serializedATN =
		...
		"\60\61\7\16\2\2\61\62\b\3\1\2\62\5\3\2\2\2\63\64\7\3\2\2\64\65\7\n\2\2"+
		"\65<\7\3\2\2\66\67\7\3\2\2\678\7\16\2\289\5\2\2\29:\7\4\2\2:;\b\4\1\2"+
		";=\3\2\2\2<\66\3\2\2\2=>\3\2\2\2><\3\2\2\2>?\3\2\2\2?@\3\2\2\2@A\7\4\2"+
		"\2AB\5\2\2\2BC\7\4\2\2CD\b\4\1\2D\7\3\2\2\2EF\7\3\2\2FG\7\13\2\2GN\7\3"+
		"\2\2HI\7\3\2\2IJ\7\16\2\2JK\5\2\2\2KL\7\4\2\2LM\b\5\1\2MO\3\2\2\2NH\3"+
		"\2\2\2OP\3\2\2\2PN\3\2\2\2PQ\3\2\2\2QR\3\2\2\2RS\7\4\2\2ST\5\2\2\2TU\7"+
		"\4\2\2UV\b\5\1\2V\t\3\2\2\2WX\5\2\2\2XY\b\6\1\2Y\13\3\2\2\2Z[\7\r\2\2"+
		"[i\b\7\1\2\\]\7\5\2\2]^\7\r\2\2^i\b\7\1\2_`\7\r\2\2`a\7\f\2\2ab\7\r\2"+
		"\2bi\b\7\1\2cd\7\5\2\2de\7\r\2\2ef\7\f\2\2fg\7\r\2\2gi\b\7\1\2hZ\3\2\2"+
