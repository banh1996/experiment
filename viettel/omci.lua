...
[53] = { me_class_name = "53 - 9.9.1  Physical path termination point POTS UNI ",
	{ attname="Administrative state", length=1, setbycreate=false },
...
[133] = { me_class_name = "ONT Power Shedding",
 ...
 [134] = { me_class_name = "9.4.1  IP host config data ",
	...
	{attname="Current IP address",	length=4,  setbycreate=false},
 ...
 [145] = { me_class_name = "145 - 9.9.10  Network dial plan table ",
 ...
 [148] = { me_class_name = "148 - 9.12.4  Authentication security method  ",
	...
	{attname="Username 2",	length=2,  setbycreate=false}},
 
 [150] = { me_class_name = "150 - 9.9.3  SIP agent config data",
 ...
 [157] = { me_class_name = "9.12.5 Large string ",
...
[264] = { me_class_name = "UNI-G",
	...
	{ attname="Administrative state", length=1, setbycreate=false },
	{ attname="Management capability", length=1, setbycreate=false },
	{ attname="Non-OMCI management identifier", length=2, setbycreate=false },
...
[280] = { me_class_name = "9.2.12 Traffic descriptor ",
	{ attname="CIR", length=4, setbycreate=true },
...
[306] = { me_class_name = "306 - 9.3.26  Dot1ag chassis-management info ",
	{ attname="Chassis ID length", length=1, setbycreate=false },
	{ attname="Chassis ID subtype", length=1, setbycreate=false },
	{ attname="Chassis ID part 1, Chassis ID part 2", length=25, setbycreate=false },
	{ attname="Management address domain length", length=1, setbycreate=false },
	{ attname="Management address domain 1, Management address domain 2", length=25, setbycreate=false },
	{ attname="Management address length", length=1, setbycreate=false },
	{ attname="Management address 1, Management address 2", length=25, setbycreate=false }},
...
[318] = { me_class_name = "318 9.12.13 File transfer controller ",
	...
	{ attname="Directory listing table", length=20, setbycreate=false }},
...
[322] = { me_class_name = "Ethernet Frame PM History Data US",
 ...
 [329] = { me_class_name = "9.5.5  Virtual Ethernet interface point  ",
	{attname="Administrative state",					length=1,  setbycreate=false},
	{attname="Operational state",					length=1,  setbycreate=false},
 ...
 [347] = { me_class_name = "9.4.5  IPv6 host config data 347",
	{attname="IP options",					length=1,  setbycreate=false},
	{attname="MAC address",					length=6,  setbycreate=false},
	{attname="Onu identifier",					length=25,  setbycreate=false},
	...
	{attname="On-link prefix",	length=16,  setbycreate=false},
